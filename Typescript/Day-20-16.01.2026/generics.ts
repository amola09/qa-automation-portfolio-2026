...
class classOne<Type1, Type2> {
  key1: Type1;
  constructor(para: Type1) {              // type1 represents key and value
    this.key1 = para;
  }
  key2(): Type2 {            // type1 represents method
...
interface interfaceTwo<Type1, Type2> {
  key1: Type1;
  key2(): Type2;
}

class classTwo implements interfaceTwo<number, string> {
  key1 = 10;
  key2() {
     console.log("I am key2");
    return "TS";
